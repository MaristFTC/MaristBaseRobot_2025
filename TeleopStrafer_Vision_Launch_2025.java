...
@TeleOp(name="MaristBot2025: Teleop Strafer Vision Launch 2025", group="Training")
//@Disabled
public class TeleopStrafer_Vision_Launch_2025 extends OpMode {
    ...
    public void loop() {
        ...
        //robot.driveTank(leftY, rightY);

        
        // Shooter
        if (gamepad1.dpad_up) {
            //robot.leftArm.setVelocity(SHOOTER_FULL);
